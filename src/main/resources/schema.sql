...
CREATE TABLE point_ledger (
    ...
    member_id       BIGINT       NOT NULL,
    usage_id        BIGINT,
    earned_point_id BIGINT,
    amount          INT          NOT NULL,
    order_no        VARCHAR(100),
    occurred_at     TIMESTAMP    NOT NULL,
    created_at      TIMESTAMP    NOT NULL,

    CONSTRAINT pk_point_ledger PRIMARY KEY (ledger_id),
    CONSTRAINT uk_point_ledger_event_id UNIQUE (event_id)
);
...
CREATE INDEX idx_point_ledger_member
    ON point_ledger (member_id);

CREATE INDEX idx_point_ledger_occurred_at
    ON point_ledger (occurred_at);
